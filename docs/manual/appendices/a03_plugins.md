...
group of **Simulation Options → 2D Surface Routing → Performance & Output**,
with
the entries
...
\figtodo{a03_backend_combo.png, The Backend combo in the Performance group of 2D Surface Routing - Performance & Output}
