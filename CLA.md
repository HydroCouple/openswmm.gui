# Contributor License Agreement — openswmm.gui

**Version 1.0 — May 2026**

Thank you for your interest in contributing to **openswmm.gui**, maintained by the Technical Manager of the project (currently [@cbuahin](https://github.com/cbuahin)). This Contributor License Agreement ("CLA") clarifies the intellectual property rights granted with contributions to the project. By signing this CLA you confirm that you have the legal authority to grant these rights, and that the Technical Manager may rely on them.
...
- **"Project"** — the openswmm.gui software repository hosted at https://github.com/HydroCouple/openswmm.gui.
...
To submit a CCLA, open a GitHub Discussion in the **[openswmm.gui Discussions](https://github.com/HydroCouple/openswmm.gui/discussions)** tab with the title `[CCLA] <Organization Name>` and include:
...
- **Discussions:** [github.com/HydroCouple/openswmm.gui/discussions](https://github.com/HydroCouple/openswmm.gui/discussions)

---

*This CLA is maintained by the Technical Manager of openswmm.gui (currently [@cbuahin](https://github.com/cbuahin)). Last updated: May 2026.*
